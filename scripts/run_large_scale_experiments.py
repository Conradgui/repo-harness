...
from repo_harness.metrics import (  # noqa: E402
...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Run RepoHarness large-scale experiments and write all experiment artifacts.")
