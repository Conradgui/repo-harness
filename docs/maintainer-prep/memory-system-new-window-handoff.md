...
RepoHarness 的记忆系统当前以“可迁移、可审核、可解释”为核心。最终版 v3 功能对标没有降低记忆治理强度；skills、workers、evidence 和 memory organize 只能产生 Review Queue candidates。
